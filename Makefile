...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:\litecoin-master-0.8\src\leveldb\libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:\litecoin-master-0.8\src\leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) clean
distclean: release-distclean debug-distclean FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) C:\litecoin-master-0.8\litecoin-qt_plugin_import.cpp

C:/litecoin-master-0.8/src/leveldb/libleveldb.a: FORCE
