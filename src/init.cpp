...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  y<port>           " + _("Listen for connections on <port> (default: 1631 or testnet: 1632)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 1630 or testnet: 1632)") + "\n" +
        ...
        "\n" + _("SSL options: (see the AIRcoin Wiki for SSL setup instructions)") + "\n" +
