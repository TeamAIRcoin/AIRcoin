...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 AIR
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 AIR mininput
...
static const int MAX_SCRIPTCHECK_THREADS = 20;
#ifdef USE_UPNP
...
public:
    ...
    */
    ...
    {
        // Large (in bytes) low-priority (new, AIRcoin) transactions
        // need a fee.
        return dPriority > COIN * 720 / 250; // 720 blocks found a day, released like clock-work
    }
